...
namespace DynamicEngine
{
    ...
    public class CollisionHandler
    {
        ...
        // BeamNG-style V2V collision (node-to-triangle)
        private readonly V2VCollision _v2vCollision;

        // Track nodes that collided this frame (for area plasticity)
        private readonly HashSet<int> _collidedNodeIndices = new HashSet<int>();
        ...
        public CollisionHandler()
        {
            ...
            _v2vCollision = new V2VCollision();
        ...
        /// <summary>
        /// Get indices of nodes that collided this frame. Used for area plasticity.
        /// </summary>
        public HashSet<int> GetCollidedNodes() => _collidedNodeIndices;

        /// <summary>
        /// Clear the collided nodes set. Call after processing plasticity.
        /// </summary>
        public void ClearCollidedNodes() => _collidedNodeIndices.Clear();
            ...
            bool visualizeForces)
        {
            ...
            // Clear collided nodes at start of frame
            _collidedNodeIndices.Clear();
                                      ...
                                      bool visualizeForces, Color debugColor)
        {
            ...
            // Track this node for area plasticity
            _collidedNodeIndices.Add(nodeIndex);
        ...
        private void ResolveCrossBodyCollisions(NodeManager nodeManagerA, Transform ownerA,
                                                ...
                                                float dt, float epsilon, bool visualizeForces)
        {
            // BeamNG-style V2V collision: nodes collide with triangles (coltris), not with other nodes
            // This replaces the old node-to-node collision system
            _v2vCollision.ResolveCollisions(dt, visualizeForces);
        }
