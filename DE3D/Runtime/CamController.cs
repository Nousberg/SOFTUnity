...
namespace DynamicEngine
{
    ...
    public class CameraVisualizerController : MonoBehaviour
    {
        ...
        private Plane fixedDragPlane;  // Add this
        ...
        private void HandleNodeGrabbing()
        {
            ...
            if (isControlPressed)
            {
                    ...
                    draggedSoftBody.solver.nodeManager.Nodes[draggedNodeIndex] != null)
                {
                    ...
                    {
                        // Safe fallback (we already checked everything is non-null above)
                ...
                // Mouse up = release
                if (Input.GetMouseButtonUp(0) && wasMousePressed)
                {
                    draggedSoftBody = null;
                    draggedNodeIndex = -1;
                    wasMousePressed = false;
